...
//    if (number_of_sensors==4){
        for(b=1; b<(number_of_sensors+1); b++){
...
//                __delay_ms(1000);
            RBIE = 1;
            sensed++;
            if (~actuator){ //if the deployment mechanism has not gone yet 
...
//            actuators_main(1);
    ...
    while (1){ //goes through this everytime a pole is detected and tires have been deployed 
        int actuator = 0;
//        lcd_clear();
//        printf("happen");
//        __delay_ms(1000);
