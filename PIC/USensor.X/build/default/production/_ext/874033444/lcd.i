...
# 2 "<built-in>" 2
# 1 "../Usensorr.X/lcd.c" 2
# 11 "../Usensorr.X/lcd.c"
# 1 "../Usensorr.X/lcd.h" 1
# 17 "../Usensorr.X/lcd.h"
...
# 18 "../Usensorr.X/lcd.h" 2

# 1 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.05\\pic\\include\\c99\\stdbool.h" 1 3
# 19 "../Usensorr.X/lcd.h" 2

# 1 "../Usensorr.X/configBits.h" 1
# 14 "../Usensorr.X/configBits.h"
...
# 118 "../Usensorr.X/lcd.h"
void putch(char data);
# 11 "../Usensorr.X/lcd.c" 2
...
static __attribute__((inline)) void pulse_e(void){
    unsigned char interruptState = INTCONbits.GIE;
    (INTCONbits.GIE = 0);
    LATDbits.LATD3 = 1;


    _delay((unsigned long)((25)*(10000000/4000000.0)));
    LATDbits.LATD3 = 0;
...
static void send_nibble(unsigned char data){
    ...
    LATD = (unsigned char)((data << 4) | LATD);
    pulse_e();
}
...
void initLCD(void){
    ...
    send_nibble(0b0011);
    _delay((unsigned long)((150)*(10000000/4000000.0)));
    ...
    { lcdInst( (unsigned char)(8 | (1 << 2) | (1 << 1) | 1) );};
}
