...
void actuators_main(int stack, int steps2_adj){
    ...
    if (act_cnt==0){
        ...
        stepper(stack);
        stepper2(0, steps2_adj);
        stepper2_back(1, steps2_adj);
        LATA = 0b00000000;
        LATCbits.LATC0 = 0;
        LATEbits.LATE0 = 0;
        LATEbits.LATE1 = 0;
...
# 182 "actuators_main.c"
          }
# 193 "actuators_main.c"
}
void servoRotate180()
{
  unsigned int i;
...
# 303 "actuators_main.c"
    ...
    if (direction == 1){
        { lcdInst(0x01); _delay((unsigned long)((5)*(10000000/4000.0)));};
                        printf("steppp %d", steps2_adj-(5));

                for(int i=0;i<(steps2_adj-(5));i++){
