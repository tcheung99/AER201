...
# 11 "../timer.X/timer.h" 2

# 1 "../timer.X/configBits.h" 1
# 14 "../timer.X/configBits.h"
...
void TIMER_INIT( void ){
    ...
    TMR0H = (65536ul - (((10000000 / (4ul))/(2ul))/1000)) >> 8;
    TMR0L = (65536ul - (((10000000 / (4ul))/(2ul))/1000));
    T0CONbits.TMR0ON = 1;
    INTCONbits.TMR0IE = 1;
