...
const int echoPin4 = 12; //D12

// defines variables
long duration;
volatile uint8_t distance1; //usensor dist 
volatile uint8_t distance2; //usensor dist 
volatile uint8_t distance3; //usensor dist 
volatile uint8_t distance4; //usensor dist 
...
void count() {
  ...
  Serial.println(dist);
  sens(echoPin1, distance1);
  sens(echoPin2, distance2);
  sens(echoPin3, distance3);
  sens(echoPin4, distance4);
  }
}

void sens(int echoPin, int distance){ 
